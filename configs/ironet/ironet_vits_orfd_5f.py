...
model = dict(
    ...
    decode_head=dict(
        ...
        # sam_prompt_test_image_embedding_size=(45, 80),
        # sam_prompt_test_image_size=(720, 1280)
        sam_prompt_test_image_embedding_size=(32, 40),
        sam_prompt_test_image_size=(512, 640)
    ),
