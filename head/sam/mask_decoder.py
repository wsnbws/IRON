...
class MaskDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.dr_embed = nn.Embedding(1, transformer_dim * 4)
        self.background_embed = nn.Embedding(1, transformer_dim * 4)
        self.dr_proj = nn.Linear(transformer_dim * 4, transformer_dim)
        self.background_proj = nn.Linear(transformer_dim * 4, transformer_dim)
    ...
    def forward(
        ...
        dr_embed = self.dr_proj(self.dr_embed.weight.unsqueeze(0).expand(B, -1, -1))  # (B, 1, C)
        ...
        # mask_token_out, src = output_tokens.squeeze(1), image_embeddings
