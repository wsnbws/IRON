...
class EncoderDecoderVideoSimple(BaseSegmentor):
    ...
    def __init__(self,
                 ...
                 test_cfg=None,
                 pretrained=None):
        super(EncoderDecoderVideoSimple, self).__init__()
    ...
    def init_weights(self, pretrained=None):
        ...
        super(EncoderDecoderVideoSimple, self).init_weights(pretrained)
